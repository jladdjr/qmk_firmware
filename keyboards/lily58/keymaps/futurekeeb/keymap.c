 ...
 */
 ...
 [_DVORAK] = LAYOUT( \
  ...
  KC_TAB,   KC_QUOT, KC_COMMA, KC_DOT,  KC_P,    KC_Y,                     KC_F,    KC_G,    KC_C,    KC_R,    KC_L,    KC_SLSH,  \
  KC_ESC,   KC_A,    KC_O,     KC_E,    KC_U,    KC_I,                     KC_D,    KC_H,    KC_T,    KC_N,    KC_S,    KC_MINUS, \
  KC_LSFT,  KC_SCLN, KC_Q,     KC_J,    KC_K,    KC_X, KC_MUTE,  KC_RBRC,  KC_B,    KC_M,    KC_W,    KC_V,    KC_Z,    KC_RSFT,  \
...
[_LOWER] = LAYOUT( \
  ...
  _______, _______, _______, _______, _______, _______, _______, KC_LBRC, XXXXXXX, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, \
...
[_RAISE] = LAYOUT( \
  ...
  KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,   _______, KC_LBRC,  KC_PLUS, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS, \
                             _______, _______, _______,  _______, _______,  _______, _______, _______ \
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
